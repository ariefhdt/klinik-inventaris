...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Jun 2019 pada 05.22
...
INSERT INTO `tb_categories` (`category_id`, `code`, `category_name`, `description`) VALUES
(1, '1001', 'Transportasi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
(2, '1002', 'Furniture', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
(3, '1003', 'elektronik', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
(4, '1004', 'peralatan', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
(5, '1005', 'ATK (Alat Tulis Kantor)', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.');
...
INSERT INTO `tb_inventory` (`inventory_id`, `code`, `category_id`, `location_id`, `brand`, `model`, `serial_number`, `status_id`, `color`, `price`, `date_purchase`, `photo`, `description`) VALUES
(1, 4001, 1, 1, 'Grand Livina', 'Mini Bus', 'BE 3567 GH', 1, 'White', 186000000, '2019-05-21', '5cf7a00ecc12b.PNG', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer congue leo leo, nec malesuada orci facilisis quis. Fusce tempor, neque nec finibus molestie, lacus arcu varius enim, in volutpat ex justo at sapien. Nulla facilisi. Phasellus auctor interdum diam. Aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultrices, odio id laoreet viverra, augue purus rutrum quam, a malesuada felis lorem non ante. Nulla consequat massa vitae dapibus scelerisque'),
(2, 4002, 1, 2, 'Grand Livina', 'Mini Bus', 'BE 1435 HI', 1, 'White', 185000000, '2019-05-01', 'default.png', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer congue leo leo, nec malesuada orci facilisis quis. Fusce tempor, neque nec finibus molestie, lacus arcu varius enim, in volutpat ex justo at sapien. Nulla facilisi. Phasellus auctor interdum diam. Aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultrices, odio id laoreet viverra, augue purus rutrum quam, a malesuada felis lorem non ante. Nulla consequat massa vitae dapibus scelerisque'),
(3, 4003, 2, 1, 'Kursi Roda', 'Astaligo', '0', 2, 'Grey', 1450000, '2019-05-08', 'default.png', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer congue leo leo, nec malesuada orci facilisis quis. Fusce tempor, neque nec finibus molestie, lacus arcu varius enim, in volutpat ex justo at sapien. Nulla facilisi. Phasellus auctor interdum diam. Aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultrices, odio id laoreet viverra, augue purus rutrum quam, a malesuada felis lorem non ante. Nulla consequat massa vitae dapibus scelerisque'),
(4, 4004, 1, 1, 'testing', 'test', '123', 1, 'red', 1223, '2017-12-12', '5cf79fe6b87eb.PNG', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer congue leo leo, nec malesuada orci facilisis quis. Fusce tempor, neque nec finibus molestie, lacus arcu varius enim, in volutpat ex justo at sapien. Nulla facilisi. Phasellus auctor interdum diam. Aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultrices, odio id laoreet viverra, augue purus rutrum quam, a malesuada felis lorem non ante. Nulla consequat massa vitae dapibus scelerisque'),
(5, 4005, 3, 1, 'piring', '123d', 'wweewe', 1, 'white', 123123, '2017-12-12', '5cfd0ffc2ff11.jpg', 'perkakas');
...
--
-- Struktur dari tabel `tb_locations`
--
...
--
-- Dumping data untuk tabel `tb_locations`
--

INSERT INTO `tb_locations` (`location_id`, `code`, `location_name`, `detail`) VALUES
(1, 2001, 'Seputih Mataram', 'Rejosari, Kec. Seputih Mataram'),
(2, 2002, 'Mataram Udik', 'Ds. Mataram Udik Kec. Bandar Mataram'),
(3, 2003, 'Padang Ratu', 'Hayungan Ratu, Kec. Padang Ratu'),
(4, 2004, 'Surabaya', 'Ds. Surabaya, Kec. Padang Ratu'),
(5, 2005, 'Karang Anyar', 'Ds. Karang Anyar, Kec. Selagai Lingga'),
(6, 2006, 'Payung Rejo', 'Ds. Payung Rejo, Kec. Pubian'),
(7, 2007, 'Segala Mider', 'Jl Pramuka Kampung Segala Mider Kec Pubian'),
(8, 2008, 'Gedung Sari', 'Gedung Sari, Kec. Anak Ratu Aji'),
(9, 2009, 'Kalirejo', 'Kalirejo, Kec. Kalirejo'),
(10, 2010, 'Poncowarno', 'Ds. Poncowarno, Kec. Kalirejo'),
(11, 2011, 'Sendang Agung', 'Ds. Sendang Agung, Kec. Sendang Agung'),
(12, 2012, 'Bangun Rejo', 'Ds. Bangunrejo, Kec. Bangunrejo'),
(13, 2013, 'Suka negara', 'Suka Negara, Kec. Bangunrejo'),
(14, 2014, 'Gunung Sugih', 'Ds. Gunung Sugih, Kec. Gunung Sugih'),
(15, 2015, 'Terbanggi Subing', 'Jl. Lintas Sumatera,Terbanggi Subing, Kec. Gunung Sugih'),
(16, 2016, 'Kesuma Dadi', 'Ds. Kasumadadi, Kec. Bekri'),
(17, 2017, 'Simbar Waringin', 'Ds. Simbar Waringin, Kec. Trimurjo'),
(18, 2018, 'Pujo Kerto', 'Jl. Raya Gotong Royong, Kec. Trimurjo');
...
INSERT INTO `tb_status` (`status_id`, `status_name`, `description`) VALUES
(1, 'Baik', 'Kondisi baik, sedang digunakan.'),
(2, 'Dalam Perbaikan', 'Sedang dalam proses perbaikan'),
(3, 'Rusak', 'Rusak, tidak dapat diperbaiki'),
(4, 'Hilang', 'Hilang');
...
--
ALTER TABLE `tb_inventory`
  MODIFY `inventory_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tb_locations`
  MODIFY `location_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `tb_status`
--
ALTER TABLE `tb_status`
  MODIFY `status_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;COMMIT;
